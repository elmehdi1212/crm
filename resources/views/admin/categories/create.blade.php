...
<div class="card">
    <div class="card-header grad1">
     <h4>   {{ trans('global.create') }} {{ trans('cruds.category.title_singular') }} </h4>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.categories.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name">{{ trans('cruds.category.fields.name') }}<span class="spa">*</span></label>
            ...
            <div>
                ...
                <a class="btn btn-warning my-2" href="{{ route('admin.categories.index') }}">
