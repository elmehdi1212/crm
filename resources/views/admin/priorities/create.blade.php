...
<div class="card">
    <div class="card-header grad1">
      <h4>  {{ trans('global.create') }} {{ trans('cruds.priority.title_singular') }} </h4>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.priorities.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name">{{ trans('cruds.priority.fields.name') }}<span class="spa">*</span></label>
            ...
            <div>
                ...
                <a class="btn btn-warning my-2" href="{{ route('admin.priorities.index') }}">
