...
<div class="card">
    <div class="card-header grad1">
      <h4>  {{ trans('global.show') }} {{ trans('cruds.comment.title') }} </h4>
    </div>
        ...
        <div class="mb-2">
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.comment.fields.reclamation') }}
                        </th>
                        <td>
                            {{ $comment->reclamation->title ?? '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
            ...
            <a style="margin-top:20px;" class="btn btn-warning" href="{{ route('admin.comments.index') }}">
