...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            @endif
            <div class="card " >
                <div class="card-header grad1"><h4> Add Claim </h4></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('reclamations.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-md-4 col-form-label text-md-right">@lang('cruds.reclamation.fields.title')</label>
                        ...
                        <div class="form-group row">
                            <label for="content" class="col-md-4 col-form-label text-md-right">@lang('cruds.reclamation.fields.content')</label>
                        ...
                        <div class="form-group row">
                            <label for="attachments" class="col-md-4 col-form-label text-md-right">{{ trans('cruds.reclamation.fields.attachments') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a class="btn btn-success my-2"  href="{{ route('reclamations.show',15)}}" >
                                  Show your Claim
                                </a>
                            </div>
                        </div>
...
Dropzone.options.attachmentsDropzone = {
    url: '{{ route('reclamations.storeMedia') }}',
    maxFilesize: 2, // MB
    addRemoveLinks: true,
    headers: {
